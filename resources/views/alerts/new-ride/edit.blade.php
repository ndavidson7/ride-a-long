<x-layouts.main title="Edit new ride alert" :$entries>
    <main>
        <div class="container py-4">
            ...
            <h2>Criteria</h2>
            <form action="{{ route('new-ride-alerts.update', $alert) }}" method="POST" id="alert-update" disabled>
                @method('PUT')
                @csrf
                <div class="row align-items-center mb-3">
                    <x-inputs.autocomplete :address="$alert->origin" size="lg" class="col-md-6 mb-3 mb-md-0" name="origin"
                        id="origin" required>
                    ...
                    <div class="col">
                        ...
                        <input type="range" class="form-range" id="origin-radius-slider"
                    ...
                    <div class="col-auto">
                        <input type="number" class="form-control form-control-lg" name="origin-radius"
                            id="origin-radius" min="0" max="100" value="{{ $alert->origin_radius }}"
                            required>
                ...
                <div class="row align-items-center mb-3">
                    <x-inputs.autocomplete :address="$alert->destination" size="lg" class="col-md-6 mb-3 mb-md-0"
                    ...
                    <div class="col">
                        ...
                        <input type="range" class="form-range" id="destination-radius-slider"
                    ...
                    <div class="col-auto">
                        <input type="number" class="form-control form-control-lg" name="destination-radius"
                            id="destination-radius" min="0" max="100"
                            value="{{ $alert->destination_radius }}" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row mb-3">
                    <x-inputs.control size="lg" type="date" class="col-md mb-3 mb-md-0" name="start-date"
                        ...
                        value="{{ $alert->start_date }}" required>
                ...
                <button type="submit" class="btn btn-danger" form="alert-destroy">Delete</button>
            </form>
            <form action="{{ route('new-ride-alerts.destroy', $alert) }}" method="POST" id="alert-destroy">
                @method('DELETE')
                @csrf
            </form>
        </div>
