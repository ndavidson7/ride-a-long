        ...
        <form id="newride" class="row col-sm-10 col-md-8 col-lg-6 mx-auto" action="{{ route('rides.store') }}"
            ...
            <div class="mb-3 col-12 autocomplete">
                ...
                <input type="hidden" class="address" id="origin-address" name="origin-address" maxlength="255"
                    required>
                <input type="hidden" class="latitude" id="origin-latitude" name="origin-latitude" required>
                <input type="hidden" class="longitude" id="origin-longitude" name="origin-longitude" required>
            </div>
            <div class="mb-3 col-12 autocomplete">
                ...
                <input type="hidden" class="latitude" id="destination-latitude" name="destination-latitude" required>
