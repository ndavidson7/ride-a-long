<x-layouts.splash title="Sign up" :$entries>
    <main>
        <div class="container-fluid align-items-center col-10 col-md-8 col-lg-6 col-lg-5 col-xxl-4 text-center">
            <form class="row form-disabled d-flex flex-column align-items-center gap-3 mb-3" action="/signup"
                method="post">
                @csrf
                ...
                <div class="d-flex gap-3">
                    <div class="form-floating col-sm-6">
                        <input type="text"
                            ...
                            name="first-name" placeholder="" autocomplete="given-name" maxlength="255" pattern="[^\d\s]+"
                    ...
                    <div class="form-floating col-sm-6">
                        <input type="text"
                            ...
                            name="last-name" placeholder="" autocomplete="family-name" maxlength="255"
                            pattern="[^\d\s]+" @error('last-name') @else value="{{ old('last-name') }}" @enderror
                            required />
                ...
                <div class="d-flex gap-3">
                    <div class="form-floating col-sm-6">
                        <input type="password"
                            ...
                            name="password" placeholder="" autocomplete="new-password" maxlength="255" required />
