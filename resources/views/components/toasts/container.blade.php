{{-- <div class="fixed bottom-3 end-3" id="toast-container">
...
<ul class="group fixed z-[99] block w-full sm:max-w-xs" x-data="{
    ...
    "
    @mouseenter="toastsHovered=true" @mouseleave="toastsHovered=false" x-init="expanded = layout === 'expanded';
    stackToasts();
    ...
    <template x-for="(toast, index) in toasts" :key="toast.id">
        <li class="absolute w-full select-none duration-300 ease-out" :id="toast.id" x-data="{
            toastHovered: false
        }"
            ...
            }, 4000);" @mouseover="toastHovered=true" @mouseout="toastHovered=false"
                ...
                <template x-if="!toast.html">
                    <div class="relative">
                        <div class="flex items-center"
                            ...
                            <svg class="-ml-1 mr-1.5 h-[18px] w-[18px]" x-show="toast.type=='info'" viewBox="0 0 24 24"
