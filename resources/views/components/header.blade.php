    ...
    <body class="d-flex flex-column h-100">
        <header class="container-fluid ps-4">
            <nav class="navbar navbar-expand navbar-light">
                <a class="navbar-brand fw-bold fs-1 text-white" href="/rides">Ride-A-Long<sub
                        class="orange">@UVA</sub></a>
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item me-2">
                        <div class="dropdown nav-link fs-1">
                            ...
                            <ul id="notifs" class="dropdown-menu dropdown-menu-end"
                                aria-labelledby="notificationsDropdown"></ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="dropdown nav-link fs-1">
                            <a class="nav-link" href="#" role="button" id="accountDropdown"
                                data-bs-toggle="dropdown" aria-expanded="false" aria-label="Account Dropdown">
...
@else
    ...
    <body class="d-flex flex-column align-items-center text-center h-100 splash">
        <header class="container-fluid">
            <h1 class="fw-bold text-white">Ride-A-Long<sub class="orange">@UVA<sup><a
                            class="disclaimer orange-darken-hover" href="#">*</a></sup></sub></h1>
        </header>
@endif
