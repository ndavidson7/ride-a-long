        ...
        <div class="col">
          <div class="card text-center h-100">
            <div class="card-body">
              ...
              <button type="button" class="card-link btn btn-uva-ob stretched-link" data-bs-toggle="modal" data-bs-target="#mapModal" data-modal-type="info" data-ride="<?= $ride["id"] ?>">More info</button>
            </div>
          </div>
        </div>
      <?php } ?>
