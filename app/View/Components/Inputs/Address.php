...
class Address extends Component
{
    ...
    public function __construct(
        ...
        if (in_array('address', $this->layers) || in_array('fine', $this->layers)) $this->addressComponents[] = 'address';
        if (in_array('locality', $this->layers) || in_array('fine', $this->layers) || in_array('coarse', $this->layers)) $this->addressComponents[] = 'city';
        if (in_array('state', $this->layers) || in_array('fine', $this->layers) || in_array('coarse', $this->layers)) $this->addressComponents[] = 'state';
        if (in_array('country', $this->layers) || in_array('fine', $this->layers) || in_array('coarse', $this->layers)) $this->addressComponents[] = 'country';
        if (in_array('fine', $this->layers)) $this->addressComponents[] = 'coordinates';
    }
